...
const NavBar = () => {
  ...
  return (
    <header
      ...
      dark:text-light relative xs:px-12 sm:px-12
    "
    >
      <button
      ...
      >
        <span
          className={`bg-dark dark:bg-light block transiton-all duration-300 ease-out h-0.5 w-6 rounded-sm xs:items-center ${
